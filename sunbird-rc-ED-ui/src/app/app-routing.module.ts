...
import { UpdateRegistrationsComponent } from './update-registrations/update-registrations.component';
...
{ path: 'update-registration', component: UpdateRegistrationsComponent, canActivate: [AuthGuard] }
];
